...
```mermaid
gantt
    title 文件备份软件：项目时间线（基于 Git 提交记录）
    dateFormat  YYYY-MM-DD
    axisFormat  %m/%d

    section 可核验里程碑（Git 提交）
    仓库初始化与初始计划（4de6f0a/8fb7bac）      :milestone, m1, 2025-10-08, 1d
    工作流与贡献规范落地（a0ae560/PR#1）          :milestone, m2, 2025-10-08, 1d
    需求分析初稿完成（ddf0ae2）                   :milestone, m3, 2025-10-11, 1d
    Qt 框架与界面骨架（5d1cfee）                  :milestone, m4, 2025-10-27, 1d
    核心备份/恢复/Manifest 主链路（5cf7422）       :milestone, m5, 2025-11-24, 1d
    Huffman 压缩与恢复选择优化（d4b6556）          :milestone, m6, 2025-11-30, 1d
    maindev 合并主干（PR#2 / 0bc942f）            :milestone, m7, 2025-11-30, 1d
    多算法扩展与实时备份（b63b129）               :milestone, m8, 2025-12-03, 1d
    自动化测试补齐（39c55ad）                     :milestone, m9, 2025-12-05, 1d
    文档补齐与验收材料整理（00db9c5/1944774）      :milestone, m10, 2025-12-11, 1d
    课程资源补充与画图指引整理（2a0e1cd）          :milestone, m11, 2025-12-22, 1d

    section 待补充项（线下讨论/评审/手工测试等）
    需求澄清与范围裁剪（会议纪要/分工确认）        :a1, 2025-10-09, 2025-10-18
    备份格式与数据结构设计（manifest/.fbk 草案）   :a2, 2025-10-12, 2025-10-26
    UI 原型走查与交互打磨（路径选择/提示文案）     :a3, 2025-10-20, 2025-11-10
    压缩/加密算法调研与接口统一（策略与枚举）      :a4, 2025-11-01, 2025-11-23
    关键缺陷修复与回归（跨平台路径/Unicode/权限）  :a5, 2025-11-24, 2025-12-02
    手工测试与演示脚本准备（GUI 流程与异常场景）   :a6, 2025-12-06, 2025-12-18
    最终答辩材料整理（截图/图表/讲解口径）         :a7, 2025-12-15, 2025-12-22
```
